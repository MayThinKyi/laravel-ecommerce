                            ...
                            @foreach ($orderDetails as $od)
                                 ...
                                 <div class="productContainer d-flex ">
                                    <div style="position:relative; width: 110px;height:80px;margin-right:10px">
                                     <img class="" style="width: 100%;height:100%;border-radius:6px;" src="{{asset('storage/'.json_decode($od->product_images)[0])}}" alt="">
                                        <span style="position:absolute;bottom:0;right:0;border-radius:5px" class="p-1 bg-primary text-white "><small>{{$od->product_price}} Ks</small></span>
                                    </div>
